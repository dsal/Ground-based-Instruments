...
In addition, you can download a sample file, as well as a CSV file containing features for the training and testing splits, from the 'Releases' section on the right.
